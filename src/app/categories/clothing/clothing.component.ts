...
export class ClothingComponent implements OnInit {
  ...
  constructor(public productService: ProductService, public flashMessageService: FlashMessagesService) { }

  ngOnInit() {
    this.productService.getProducts()
    .pipe(
        map((products:Product[]) => products.filter(product =>  product.category == 'Clothing'))
    )
